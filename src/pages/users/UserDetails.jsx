  ...
  const postColumns = [
    {
      ...
      render: (post) => (
        <div className="max-w-md">
          <p className="text-sm font-semibold text-gray-900 line-clamp-1">{post.title || 'بدون عنوان'}</p>
    ...
    },
    {
      ...
      render: (post) => {
        ...
        const config = statusConfig[post.status] || { label: post.status, color: 'bg-gray-100 text-gray-700 border-gray-200' };
        return (
          <span className={`px-3 py-1.5 rounded-lg text-sm font-semibold border ${config.color}`}>
            {config.label}
          </span>
    ...
    },
    {
      ...
      render: (post) => (
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-bold text-gray-900">{post._count?.likes || 0}</span>
        </div>
      )
    },
    {
      ...
      render: (post) => (
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-bold text-gray-900">{post._count?.comments || 0}</span>
        </div>
      )
    },
    {
    ...
    <div className="space-y-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-6 flex-wrap">
              ...
              <div className="flex items-center gap-2 text-gray-600">
                <FileText size={20} />
                <div>
                  <p className="text-lg font-semibold text-gray-900">{user._count?.posts || 0}</p>
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <div>
                  <p className="text-lg font-semibold text-gray-900">{user._count?.comments || 0}</p>
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <div>
                  <p className="text-lg font-semibold text-gray-900">{user._count?.likes || 0}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="glass-card rounded-xl p-6 text-center border border-gray-200">
          ...
          <p className="text-3xl font-bold text-gray-900 mb-1">{user._count?.likes || 0}</p>
