...
const WithdrawalDetails = () => {
  ...
  let accountDetails = {};
  try {
    accountDetails = typeof withdrawalData.accountDetails === 'string' 
      ? JSON.parse(withdrawalData.accountDetails || '{}')
      : withdrawalData.accountDetails || {};
  } catch (e) {
    accountDetails = { details: withdrawalData.accountDetails };
  }
